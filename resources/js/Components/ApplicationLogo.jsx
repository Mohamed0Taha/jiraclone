    ...
    return (
        <svg {...props} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <g transform="translate(100,100)">
                {/* Main compass points */}
                <line x1="0" y1="-70" x2="0" y2="-50" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round"/>
                <line x1="70" y1="0" x2="50" y2="0" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round"/>
                <line x1="0" y1="70" x2="0" y2="50" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round"/>
                <line x1="-70" y1="0" x2="-50" y2="0" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round"/>
                
                {/* Diagonal compass points */}
                <line x1="50" y1="-50" x2="35" y2="-35" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round"/>
                <line x1="50" y1="50" x2="35" y2="35" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round"/>
                <line x1="-50" y1="50" x2="-35" y2="35" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round"/>
                <line x1="-50" y1="-50" x2="-35" y2="-35" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round"/>
            </g>
            ...
            <g transform="translate(100,100)">
                ...
                <g transform="translate(30,-30) scale(0.8)">
                    ...
                    <path d="M-4,0 L-1,3 L4,-3" stroke="#4F46E5" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                </g>
