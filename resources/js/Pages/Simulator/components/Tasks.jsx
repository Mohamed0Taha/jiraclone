...
// Removed mock tasks to avoid showing placeholders
const MOCK_TASKS = [];

const priorityColor = (p) => ({ High: 'error', Medium: 'warning', Low: 'success' })[p] || 'default';
const statusColor = (s) =>
    ({ Completed: 'success', 'In Progress': 'warning', Pending: 'default' })[s] || 'default';
...
export default function Tasks({
    ...
    canAddTask = false,
    onShowAddTask,
    onTaskAction, // New prop for advanced task actions
    currentWeek,
    simulationState,
    events = [],
    resolvedEventIds = [],
