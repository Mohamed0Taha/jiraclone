...
function EventsComponent({
    ...
    const visibleEvents = useMemo(() => {
        ...
        return list
            ...
            .sort(
                (a, b) => (b.trigger_week || 0) - (a.trigger_week || 0) || (b.id > a.id ? 1 : -1)
            );
        ...
        <Box>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
                ...
                {visibleEvents.some(
                    (e) =>
                        e.requiresAction ||
                        e.effects?.resolution_requires_action ||
            ...
            <Stack spacing={1.25}>
                {visibleEvents.map((e) => {
                    ...
                    const actionable =
                        ...
                        e.effects?.resolution_requires_action === true ||
                        e.resolution_requires_action === true;
                        ...
                        <Card
                            ...
                            sx={{
                                ...
                                background: (() => {
                                    ...
                                    if (actionable)
                                        return 'linear-gradient(90deg, rgba(255,165,0,0.15), transparent)';
                                    return 'transparent';
                                })(),
                                '&:hover': {
                            ...
                            <CardContent sx={{ py: 1.1, '&:last-child': { pb: 1.1 } }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {occurred && (
                                            <Chip size="small" label="Occurred" color="success" />
                                        )}
                                        {!occurred && (
                                            <Chip size="small" label="Upcoming" color="default" />
                                        )}
                                        {actionable && (
                                            <Chip
                                                size="small"
                                ...
                                <Collapse
                                    in={selected && actionable && e.resolution_options?.length > 0}
                                    unmountOnExit
                                >
                                    <Divider sx={{ my: 1 }} />
                                    <Stack spacing={1}>
                                        {(e.resolution_options || []).map((opt) => (
                                            ...
                                            >
                                                ...
                                                <Button
                                                    ...
                                                    onClick={(evt) => {
                                                        evt.stopPropagation();
                                                        handleResolve(e, opt.key || opt.id);
                                                    }}
                                                >
                                                    Apply
                                                </Button>
