...
export default function Edit({ auth, project }) {
  ...
  useEffect(() => {
    transform((d) => ({
      ...d,
      key: (d.key || "").toUpperCase().replace(/[^A-Z0-9]/g, "").slice(0, 12),
    }));
  }, [transform]);
        ...
        >
          ...
          <Container maxWidth="md" sx={{ position: "relative" }}>
            ...
            <Typography variant="h6" sx={{ mt: 2, maxWidth: 720, color: alpha("#fff", 0.92) }}>
              Update the project basics, context, and description. Your changes will improve AI suggestions across the app.
            </Typography>
                ...
                <Box component="form" onSubmit={submit} noValidate autoComplete="off">
                  {activeStep === 0 && (
                    <Stack spacing={3}>
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            helperText={errors.key || "Uppercase letters & digits only (max 12)."}
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                        ...
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) =>
                              setData("meta", { ...data.meta, team_size: e.target.value ? Number(e.target.value) : "" })
                            }
                      ...
                      <Stack direction="row" justifyContent="flex-end" spacing={1.5} mt={1}>
                        <Button variant="contained" onClick={next} sx={{ textTransform: "none", fontWeight: 700 }}>
                          Next
                        </Button>
                      </Stack>
                    </Stack>
                  ...
                  {activeStep === 1 && (
                    <Stack spacing={3}>
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) => setData("meta", { ...data.meta, project_type: e.target.value })}
                            error={Boolean(errors?.["meta.project_type"])}
                        ...
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) => setData("meta", { ...data.meta, domain: e.target.value })}
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) => setData("meta", { ...data.meta, area: e.target.value })}
                        ...
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) => setData("meta", { ...data.meta, location: e.target.value })}
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) => setData("meta", { ...data.meta, budget: e.target.value })}
                        ...
                        <Grid item xs={12} sm={6}>
                          <TextField
                            ...
                            onChange={(e) =>
                              setData("meta", { ...data.meta, primary_stakeholder: e.target.value })
                            }
                            error={Boolean(errors?.["meta.primary_stakeholder"])}
                            helperText={errors?.["meta.primary_stakeholder"]}
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                      ...
                      <TextField
                        ...
                        onChange={(e) => setData("meta", { ...data.meta, objectives: e.target.value })}
                      ...
                      <TextField
                        ...
                        onChange={(e) => setData("meta", { ...data.meta, constraints: e.target.value })}
                      ...
                      <Stack direction="row" justifyContent="space-between" spacing={1.5} mt={1}>
                        <Button variant="outlined" onClick={back} sx={{ textTransform: "none", fontWeight: 600 }}>
                          Back
                        </Button>
                        <Button variant="contained" onClick={next} sx={{ textTransform: "none", fontWeight: 700 }}>
                          Next
                  ...
                  {activeStep === 2 && (
                    <Stack spacing={3}>
                      ...
                      >
                        The context below will be appended to your description as a structured summary to help AI features.
                      </Alert>
                        ...
                        <Stack direction="row" spacing={1.5}>
                          ...
                          <Button
                            ...
                            sx={{
                              ...
                              fontWeight: 700,
                              px: 3,
                              boxShadow: "0 6px 18px -6px rgba(0,0,0,.25), 0 8px 32px -12px rgba(0,0,0,.25)",
                            }}
                          >
