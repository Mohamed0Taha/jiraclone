...
export const validateStep = (idx, data, setLocalErrors) => {
  ...
  if (idx === 0) {
    const e1 = validators.name(data.name); if (e1) err.name = e1;
    const e2 = validators.key(data.key);   if (e2) err.key  = e2;
    const e3 = validators.description(data.description); if (e3) err.description = e3;
  }
