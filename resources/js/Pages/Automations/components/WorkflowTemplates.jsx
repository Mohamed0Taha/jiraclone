      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ ml: 5.5, maxWidth: 600 }}>
              Pick a vibrant starting point and customize your workflow with our professionally designed templates
            </Typography>
          </Box>
      ...
      >
        <Box position="relative" zIndex={1}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3, maxWidth: 600 }}>
            Templates are great starters—customize triggers, actions, and more to create a workflow that fits your team perfectly.
          </Typography>
          <Button
            variant="contained"
            color="success"
