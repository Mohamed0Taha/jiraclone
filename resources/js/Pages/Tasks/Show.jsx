...
export default function TaskShow({ auth, project, taskData, users, priorities }) {
  ...
  const handleUpdateComment = () => {
    router.patch(route('comments.update', [project.id, taskData.id, editingComment.id]), {
  ...
  const renderComment = (comment, isReply = false) => (
    <Card 
      ...
      sx={{ 
        ...
        borderRadius: 2,
        border: isReply ? '1px solid rgba(25, 118, 210, 0.2)' : '1px solid rgba(0,0,0,0.12)',
        boxShadow: isReply ? '0 2px 8px rgba(25, 118, 210, 0.1)' : '0 2px 8px rgba(0,0,0,0.1)',
        transition: 'all 0.2s ease-in-out',
        '&:hover': {
          boxShadow: isReply ? '0 4px 16px rgba(25, 118, 210, 0.15)' : '0 4px 16px rgba(0,0,0,0.15)',
    ...
    <AuthenticatedLayout
      ...
      header={
        <Box sx={{ width: '100%', overflow: 'hidden' }}>
          ...
          <Typography variant="subtitle1" color="text.secondary" sx={{ ml: 0.5, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {project.name}
          </Typography>
        </Box>
      }
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        >
          <Stack direction="row" justifyContent="space-between" alignItems="flex-start" sx={{ mb: 3 }}>
            <Box sx={{ flexGrow: 1, mr: 2, minWidth: 0 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Created by {taskData.creator?.name} on {new Date(taskData.created_at).toLocaleDateString()}
              </Typography>
            </Box>
            <Button
              variant="contained"
          ...
          <Stack direction="row" spacing={2} sx={{ mb: 3, flexWrap: 'wrap', gap: 1 }}>
            ...
            />
            <Chip
              label={taskData.status.charAt(0).toUpperCase() + taskData.status.slice(1)}
              variant="outlined"
              sx={{
                borderColor: 'primary.main',
                color: 'primary.main',
