        ...
        <AuthenticatedLayout user={auth?.user}>
            ...
            <Container maxWidth="md" sx={{ py: 6 }}>
                <Stack spacing={3}>
                        ...
                        <CardContent>
                            <Stack spacing={2}>
                                <Stack direction="row" spacing={2} justifyContent="center">
                                    ...
                                    <Chip
                                        label={`Percentage: ${pct.toFixed(1)}%`}
                                        color={pct >= 80 ? 'success' : 'warning'}
                                    />
                                </Stack>
                                <Box>
                                ...
                                {theoryQuestions && theoryQuestions.length ? (
                                    theoryQuestions.map((q, idx) => {
                                        const correct = Array.isArray(q.correct_answer)
                                            ...
                                            : q.correct_answer || '—';
                                        const userAns = Array.isArray(q.user_answer)
                                            ? q.user_answer.join(', ')
                                            : q.user_answer || '—';
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Chip
                                                        size="small"
                                                        label={`${q.points_earned || 0}/${q.max_points || 0} pts`}
                                                        color={q.is_correct ? 'success' : 'default'}
                                                    />
                                                </Stack>
                                                <Divider sx={{ my: 1 }} />
                                                <Typography
                                                ...
                                                {q.explanation && (
                                                    <Typography
                                                        ...
                                                        color="info.main"
                                                    >
                                                        <strong>Explanation / Ideal:</strong>{' '}
                                                        {q.explanation}
                                                    </Typography>
                                                )}
                                            </Box>
                    ...
                    >
                        <Button
                            onClick={() => router.post(route('certification.reset'))}
                            variant="outlined"
                            color="inherit"
                        >
                            Restart
                        ...
                        <Button
                            onClick={() => router.post(route('certification.generate-simulation'))}
                            variant="contained"
                            color="primary"
                        >
