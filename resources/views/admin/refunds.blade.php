<x-admin.layout 
    ...
    @php
        ...
        $refunds = ($refundLogs ?? ($refunds ?? collect()));
        if(! $refunds instanceof \Illuminate\Contracts\Pagination\LengthAwarePaginator && ! $refunds instanceof \Illuminate\Support\Collection){
            $refunds = collect();
        }
    @endphp
    ...
    <!-- Removed legacy Bootstrap duplicate sections to prevent duplicated content / layout issues -->
